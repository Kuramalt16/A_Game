...
def Settings(screen):
    ...
    text = Ff.display_text(screen, "RESOLUTION: ", 30, (CB_LEFT, CB_TOP * 2.1), "black")
    slider = Ff.add_image_to_screen(screen, 'static/images/Slider.png', [S.SCREEN_WIDTH / 2, SLIDER_TOP, SLIDER_WIDTH, SLIDER_HEIGHT])
    ...
    text = Ff.display_text(screen, "FRAME RATE: ", 30, (CB_LEFT, CB_TOP * 3.2), "black")
    # slider = Ff.add_image_to_screen(screen, 'static/images/Slider.png', [S.SCREEN_WIDTH / 2, SLIDER_TOP*1.5, SLIDER_WIDTH, SLIDER_HEIGHT])
    # buttons['Slider_button_fps'] = Ff.add_image_to_screen(screen, 'static/images/Slider_button.png', [(SLIDER_MAX-SLIDER_MIN) * S.RESOLUTION + SLIDER_MIN, SLIDER_TOP, CB_WIDTH, SLIDER_BUTTON_HEIGHT])
    I.pg.display.flip()
    return buttons
